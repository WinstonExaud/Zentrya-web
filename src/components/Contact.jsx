...
// Contact Us page for Zentrya Tv - Multiple contact methods and support options
  ...
  const socialMedia = [
    {
      name: "Facebook",
      icon: Facebook,
      url: "https://facebook.com/Zentrya Tv",
      handle: "@Zentrya Tv",
      color: "#1877F2"
    },
    {
      name: "Twitter",
      icon: Twitter,
      url: "https://twitter.com/Zentrya Tv",
      handle: "@Zentrya Tv",
      color: "#1DA1F2"
    },
    {
      name: "Instagram",
      icon: Instagram,
      url: "https://instagram.com/zentryatv",
      handle: "@zentryatv",
      color: "#E4405F"
    },
    {
       ...
       <section className="relative pt-32 pb-24 px-6 md:px-12 overflow-hidden min-h-[70vh] flex items-center">
        ...
        <div className="relative max-w-5xl mx-auto text-center z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
            ...
            <span className="block text-white">With Zentrya tv</span>
          </h1>
