...
// About Us page for Zentrya Tv - Netflix-style with Tanzania focus
...
export default function About() {
  ...
  const contentFocus = [
    ...
    },
    {
      ...
      description: "Zentrya Tv Original productions featuring Tanzanian talent and stories that matter to us."
    }
  ];
      ...
      <section className="relative pt-32 pb-24 px-6 md:px-12 overflow-hidden min-h-[70vh] flex items-center">
        ...
        <div className="relative max-w-5xl mx-auto text-center z-10">
          ...
          <p className="text-lg md:text-xl text-gray-200 mb-10 max-w-3xl mx-auto leading-relaxed">
            Zentrya tv brings world-class streaming to Tanzania with African stories, global blockbusters, 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                <span className="text-yellow-500 font-semibold">Zentrya tv</span> is a next-generation 
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                Zentrya tv's mission is to make high-quality entertainment universally accessible, locally 
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-gray-800 via-gray-900 to-black p-10 rounded-2xl border border-yellow-500/30 hover:border-yellow-500/50 transition-all">
                ...
                <p className="text-gray-300 leading-relaxed text-lg">
                  ...
                  screens and Zentrya tv serves as the gateway to world-class entertainment.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-gray-900">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-6">
                <a href="https://www.facebook.com/zentrya" target="_blank" rel="noopener noreferrer" title="Zentrya Tv" className="text-gray-500 hover:text-yellow-500 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="https://twitter.com/zentrya" target="_blank" rel="noopener noreferrer" title="Zentrya Tv" className="text-gray-500 hover:text-yellow-500 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
