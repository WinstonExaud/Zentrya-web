...
// Enhanced landing page with real backend integration - Netflix-style for Zentrya Tanzania
    ...
    <main className="min-h-screen w-full bg-black text-white font-sans">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-start justify-center h-full px-6 md:px-12 max-w-3xl">
          ...
          <p className="text-base md:text-lg text-gray-300 mb-8">
            Start your journey with Zentrya today.
          </p>
      ...
      <section className="px-6 md:px-12 py-24 bg-black">
        <h2 className="text-3xl md:text-5xl font-bold mb-4 max-w-6xl mx-auto">
          Why You’ll Love <span className="text-yellow-500">Zentrya</span>
        </h2>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gradient-to-br from-yellow-900/20 via-black to-black rounded-2xl p-8 border border-yellow-500/20 hover:border-yellow-500/50 transition-all group hover:scale-105 transform duration-300">
            ...
            <p className="text-gray-300 leading-relaxed">
              Watch Zentrya on Smart TVs, PlayStation, Xbox, Chromecast, Apple TV, and more. Bring cinema home.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto space-y-3">
          <details className="bg-gradient-to-r from-gray-900 to-gray-900/90 hover:from-gray-800 hover:to-gray-800/90 transition-all group rounded-lg overflow-hidden border border-gray-800 hover:border-yellow-500/30">
            <summary className="px-6 md:px-8 py-6 cursor-pointer flex items-center justify-between text-lg md:text-xl font-bold">
              <span className="text-white">What is Zentrya?</span>
            ...
            <div className="px-6 md:px-8 pb-6 text-gray-300 leading-relaxed space-y-4">
              <p>Zentrya is Tanzania’s premier streaming platform, designed to bring the best of local and international entertainment right to your fingertips. Whether you love movies, TV series, documentaries, or short films, Zentrya has something for everyone.</p>
          ...
          <details className="bg-gradient-to-r from-gray-900 to-gray-900/90 hover:from-gray-800 hover:to-gray-800/90 transition-all group rounded-lg overflow-hidden border border-gray-800 hover:border-yellow-500/30">
            <summary className="px-6 md:px-8 py-6 cursor-pointer flex items-center justify-between text-lg md:text-xl font-bold">
              <span className="text-white">How much does Zentrya cost?</span>
              <span className="text-3xl md:text-4xl text-yellow-500 group-open:rotate-45 transition-transform duration-300">+</span>
            </summary>
          ...
          <details className="bg-gradient-to-r from-gray-900 to-gray-900/90 hover:from-gray-800 hover:to-gray-800/90 transition-all group rounded-lg overflow-hidden border border-gray-800 hover:border-yellow-500/30">
            ...
            <div className="px-6 md:px-8 pb-6 text-gray-300 leading-relaxed">
              <p>Watch on smart TVs, smartphones, tablets, computers, and game consoles. Access Zentrya on any internet-connected device.</p>
            </div>
          </details>
          ...
          <details className="bg-gradient-to-r from-gray-900 to-gray-900/90 hover:from-gray-800 hover:to-gray-800/90 transition-all group rounded-lg overflow-hidden border border-gray-800 hover:border-yellow-500/30">
            <summary className="px-6 md:px-8 py-6 cursor-pointer flex items-center justify-between text-lg md:text-xl font-bold">
              <span className="text-white">What can I watch on Zentrya?</span>
              <span className="text-3xl md:text-4xl text-yellow-500 group-open:rotate-45 transition-transform duration-300">+</span>
            </summary>
            <div className="px-6 md:px-8 pb-6 text-gray-300 leading-relaxed">
              <p>Enjoy an extensive library featuring Tanzanian films, African cinema, Africa blockbusters, documentaries, TV series and exclusive Zentrya Originals.</p>
            </div>
          </details>

          <details className="bg-gradient-to-r from-gray-900 to-gray-900/90 hover:from-gray-800 hover:to-gray-800/90 transition-all group rounded-lg overflow-hidden border border-gray-800 hover:border-yellow-500/30">
            <summary className="px-6 md:px-8 py-6 cursor-pointer flex items-center justify-between text-lg md:text-xl font-bold">
              <span className="text-white">Is Zentrya good for the family?</span>
              <span className="text-3xl md:text-4xl text-yellow-500 group-open:rotate-45 transition-transform duration-300">+</span>
            </summary>
            <div className="px-6 md:px-8 pb-6 text-gray-300 leading-relaxed space-y-4">
