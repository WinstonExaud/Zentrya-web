  ...
  const sections = [
    {
      ...
      content: `By accessing and using Zentrya's streaming service ("Service"), you accept and agree to be bound by these Terms of Use. If you do not agree to these terms, please do not use our Service.
...
These terms constitute a legally binding agreement between you and Zentrya Ltd., a company registered in Tanzania. Your continued use of the Service indicates your acceptance of these terms and any modifications thereof.`
    },
    {
      ...
      content: `Zentrya provides a subscription-based streaming service that allows members to access entertainment content, including movies, TV shows, documentaries, and other video content over the internet to certain internet-connected devices.
...
6.2 License: All content on Zentrya is licensed, not sold. We grant you a limited, non-exclusive, non-transferable license to stream and view content through the Service for personal, non-commercial use only.
...
Our trademarks and trade dress may not be used in connection with any product or service without our prior written consent.`
    },
    {
      ...
      content: `If our Service allows you to post reviews, comments, or other content, you grant Zentrya a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, and distribute such content in connection with the Service.
...
We do not warrant that the Service will be uninterrupted, secure, or error-free, or that any defects will be corrected. You use the Service at your own risk.`
    },
    {
      ...
      content: `TO THE MAXIMUM EXTENT PERMITTED BY LAW, ZENTRYA SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES.
...
Your continued use of the Service after any changes constitutes your acceptance of the new Terms. If you do not agree to the modified Terms, you must stop using the Service.`
    },
    {
      ...
      content: `16.1 Entire Agreement: These Terms, together with our Privacy Policy and any other legal notices published by us, constitute the entire agreement between you and Zentrya.
...
16.5 Contact: For questions about these Terms, please contact us at legal@zentrya.com.`
    }
  ];
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Please read these Terms of Use carefully before using Zentrya's streaming service. 
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  By clicking "I Agree" during registration or by continuing to use the Zentrya service, 
