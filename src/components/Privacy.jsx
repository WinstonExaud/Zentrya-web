...
// Privacy Policy page for Zentrya Tv
  ...
  const sections = [
    {
      ...
      icon: Shield,
      content: `Welcome to Zentrya Tv. We respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our streaming service.

This policy applies to all users of Zentrya Tv's services, including our website, mobile applications, and any related services (collectively, the "Service").
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  At Zentrya Tv, we are committed to protecting your privacy and being transparent about 
          ...
          <div className="mt-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-gray-400 text-sm">
                  Legal terms governing your use of Zentrya Tv's service
                </p>
              </Link>
