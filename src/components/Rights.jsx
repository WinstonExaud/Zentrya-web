...
// Copyright Policy page for Zentrya
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Zentrya respects the intellectual property rights of others and expects users to do the same.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              All content available on Zentrya, including but not limited to movies, TV shows, images, text, graphics, logos, button icons, audio clips, and software, is the property of Zentrya, its content suppliers, or licensors and is protected by Tanzanian and international copyright laws.
            </p>
            <p className="text-gray-300 leading-relaxed">
              The compilation of all content on this service is the exclusive property of Zentrya and protected by Tanzanian and international copyright laws.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Subject to your compliance with these Terms of Use, Zentrya grants you a limited, non-exclusive, non-transferable license to:
            </p>
          ...
          <div className="bg-gradient-to-br from-black to-gray-800 p-8 rounded-xl border border-gray-700">
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Zentrya respects the intellectual property rights of others. If you believe that your copyrighted work has been copied in a way that constitutes copyright infringement, please provide our Copyright Agent with the following information:
            </p>
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">
              Zentrya will terminate the accounts of users who are repeat infringers of intellectual property rights. We reserve the right to terminate accounts of users who violate copyright laws, whether or not there is repeat infringement.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">
              ZENTRYA and all related logos, product and service names, designs, and slogans are trademarks of Zentrya Ltd. You may not use these marks without our prior written permission. All other names, logos, product and service names, designs, and slogans on this Service are the trademarks of their respective owners.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              If you are interested in licensing content from Zentrya for commercial purposes, please contact our business development team:
            </p>
            <p className="text-gray-300 leading-relaxed">
